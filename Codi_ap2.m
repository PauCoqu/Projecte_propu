...
% Pressure ratios
% -------------------------
pi_d   = 0.98;             % inlet pressure recovery
pi_fan = 1.45;              % fan pressure ratio
pi_LPC = 5.057;             % low pressure compressor ratio
pi_HPC = 6.6;              % high pressure compressor ratio
pi_b   = 0.90;             % combustor pressure ratio
...
eta_m = 0.95;              % mechanical efficiency (mateixa per HP i LP)

eta_n_p = 0.90;            % primary nozzle efficiency
eta_n_s = 0.90;            % secondary nozzle efficiency
...
mdot_core = mdot_c25 * (pt_25/pref) / sqrt(Tt_25/Tref);
mdot_sec = alpha*mdot_core;
